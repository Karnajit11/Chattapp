      ...
      async.waterfall([
        ...
        function(data, callback) {
          if(req.body.message){
            ...
            newMassage.sender = req.user._id;
            newMassage.receiver = data._id;
            newMassage.senderName = req.user.username;
            newMassage.receiverName = data.username;
            newMassage.message = req.body.message;
            newMassage.userImage = req.user.userImage;
            newMassage.createdAt = new Date();

            newMassage.save((err, result) => {
              if(err) {
                return next(err);
              }
              callback(err, result);
